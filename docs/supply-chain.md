...
```text
https://github.com/aoci-spec/aoci-code/.github/workflows/release.yml@refs/tags/v0.1.0-rc10
```
...
`AOCI-CODE_v0.1.0-rc10.provenance.sigstore.json`. Verification constrains the
