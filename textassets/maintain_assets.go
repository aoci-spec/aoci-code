...
const (
	...
	ContractMaintainActionApplyFinalProof          ID = "contracts/maintain/actions/apply-final-proof"
	ContractMaintainActionApplyDuplicateFinalProof ID = "contracts/maintain/actions/apply-duplicate-final-proof"
