...
var localizedFlagNames = []string{
	...
	"snapshot-file", "plan-file", "candidate-file", "target-index", "mapping-file", "preview-file", "baseline-timestamp",
...
var commandShortMessages = map[string]string{
	...
	"aoci cognition plan diff":                   "cli.short.cognition_plan_diff",
