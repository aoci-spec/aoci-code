...
| Installation, upgrade, and rollback | [Install](docs/install.md) · [Upgrade](docs/upgrading.md) · [Rollback](docs/rollback.md) · [Uninstall](docs/uninstall.md) |
| AI Agents and hosts | [Agent Integrations](docs/agent-integrations.md) · [Windows Host Agent](docs/windows-host-agent.md) |
| Whole-Index and refresh | [Overview Delivery](docs/overview-delivery.md) · [Cognition Refresh](docs/cognition-refresh.md) |
| Cognition Volumes | [Volumes](docs/cognition-volumes.md) · [Volumes Contract](spec/public/aoci-cognition-volumes-v1.txt) |
| System Cognition | [System Cognition Runtime Contract](spec/public/aoci-system-cognition-runtime-v1.txt) |
| Managed Scope | [Managed Scope and Budget](docs/managed-scope-and-budget.md) · [Safe Inventory](docs/safe-inventory-and-scope-refresh.md) |
| Database | [Database Evidence](docs/database-evidence.md) · [Database Cognition Authoring](docs/database-cognition-authoring.md) |
| Lifecycle | [Getting Started](docs/getting-started.md) · [Upgrade](docs/upgrading.md) · [Cognition Refresh](docs/cognition-refresh.md) |
| Formats and protocols | [Index Format](spec/public/aoci-index-format-v1.txt) · [Cognition Volumes Spec](spec/public/aoci-cognition-volumes-v1.txt) · [Object FRAS v2](spec/public/aoci-object-fras-v2.txt) |
| Research and release | [Supply Chain](docs/supply-chain.md) |

> The relative links above require this file to remain at the root of the AOCI-CODE repository.
...
The project is not currently open to general external contributions. Read [CONTRIBUTING.md](CONTRIBUTING.md) before submitting changes. Until the rights holder approves a public contribution policy, inbound-licensing boundaries may restrict the acceptance and use of pull requests.

Do not disclose suspected vulnerabilities in public Issues. Follow [SECURITY.md](SECURITY.md); a monitored private reporting channel and clear response ownership remain prerequisites for a public Release.
