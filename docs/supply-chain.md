...
```text
https://github.com/aoci-spec/aoci-code/.github/workflows/release.yml@refs/tags/v0.1.0-rc8
```
...
`AOCI-CODE_v0.1.0-rc8.provenance.sigstore.json`. Verification constrains the
