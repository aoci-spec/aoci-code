...
var requiredEntryWriteMessages = map[string][]any{
	...
	"entry.repair.cause.directory_unspellable":                    {"directory"},
	"entry.repair.cause.root_unspellable":                         {"directory"},
	...
	"entry.repair.action.directory_unspellable":                   nil,
	"entry.repair.action.root_unspellable":                        nil,
	"entry.repair.action.code_candidate_id":                       nil,
	"entry.repair.action.database_candidate_id":                   nil,
	"entry.repair.action.database_batch_id":                       nil,
	"entry.repair.cause.database_candidate_id":                    nil,
	"entry.repair.cause.database_batch_id":                        nil,
