...
import (
	...
	"errors"
	"fmt"
	pgpassfile "gitcode.com/opengauss/openGauss-connector-go-pq/pgpassfile"
	"gitcode.com/opengauss/openGauss-connector-go-pq/pgservicefile"
	"math"
	"net"
	"net/url"
	"os"
...
func parseEnvSettings() map[string]string {
	...
	nameMap := map[string]string{
		...
		"PGLOGGERLEVEL":        paramLoggerLevel,
	}
